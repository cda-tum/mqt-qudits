...
class TestLevelGraph(TestCase):
    ...
    def test_logic_physical_map(self):
        self.assertEqual(self.graph_1.log_phy_map, [3, 2, 4, 1, 0])
    ...
    def test_get_rz_gates(self):
        ...
        self.assertEqual(rzs[0].lev_a, 3)
        self.assertEqual(rzs[1].lev_a, 2)
        self.assertEqual(rzs[0].phi, 1)
        self.assertEqual(rzs[1].phi, 1)
