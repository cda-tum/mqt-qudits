...
class TestCRot(TestCase):
    ...
    def test_crot_101_as_list(self):
        rTT = self.circuit_33.r(0, [0, 1, 1.0471975511965972, -2.513274122871836]).to_matrix().round(3)
        ...
        r = self.circuit_33.r(0, [0, 1, 1.0471975511965972, -2.513274122871836]).to_matrix()
        x = 0
