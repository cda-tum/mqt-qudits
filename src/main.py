...
qreg_example = QuantumRegister("reg", 2, [2, 4])
...
#h = circ.h(0)
#r = circ.r(2, [0, 1, np.pi / 5 + np.pi, np.pi / 7]).control([1], [0])

#x = circ.x(0).control([2], [2])
# print(h.to_matrix().round(3))
# print(x.to_matrix().round(3))
# cx = circ.cx([0, 1], [0, 1, 1, np.pi/2])
# cx2 = circ.cx([1, 0],[0, 1, 0, np.pi/12])
csum = circ.csum([1, 0])
...
# con +
# [[0.9511+0.j     0.1341-0.2784j 0.    +0.j    ]]
# [[ 0.9511+0.j     -0.1341-0.2784j  0.    +0.j    ]]
# con -
# [[ 0.9511+0.j     -0.1341-0.2784j  0.    +0.j    ]]
# [[0.9511+0.j     0.1341-0.2784j 0.    +0.j    ]]
...
# con - theta e - ohi
# [[-0.309 -0.j     -0.4126-0.8569j  0.    +0.j    ]]
# [[-0.309 +0.j      0.4126-0.8569j  0.    +0.j    ]]
# con - theta e + ohi
# [[-0.309 +0.j      0.4126-0.8569j  0.    +0.j    ]]
# [[-0.309 +0.j     -0.4126-0.8569j  0.    +0.j    ]]
...
result = job.result()
print(result.get_state_vector().round(3))
# print(r.to_matrix(2))
